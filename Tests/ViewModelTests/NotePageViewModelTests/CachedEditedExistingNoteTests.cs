...
{
    /// <summary>
    /// Scenario: User opens existing note, edits, then leaves the page by means other than closing such that the note is cached.
    /// Then the user re-opens the note page.
    /// </summary>
    public class CachedEditedExistingNoteTests
    {
        MockAppServiceProvider Services;
        public CachedEditedExistingNoteTests()
        {
